...
public class CommandsMenu extends AbstractMenu {
	...
	protected CommandsMenu(Shell parent, int style, CommandsMenuActions actions, OpenersMenu openersMenu) {
		...
		initMenuItem(this, "menu.commands.delete", Platform.MAC_OS ? "Del" : "Del", /* this is not a global key binding */ null, actions.delete, true);
		initMenuItem(this, null, null, null, null);
		initMenuItem(this, "menu.commands.copy", Platform.MAC_OS ? "Ctrl+C" : "Ctrl+C", /* this is not a global key binding */ null, actions.copyIP);
